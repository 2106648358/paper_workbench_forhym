      ...
      series: [
        {
          ...
          labelLine: {
            ...
            length: is3D ? 20 : 10,
            length2: is3D ? 15 : 10,
            lineStyle: { color: '#d1cfc5', width: 1 },
          },
          emphasis: {
            itemStyle: {
              shadowBlur: is3D ? 20 : 10,
              shadowOffsetX: 0,
              shadowColor: is3D ? 'rgba(0, 0, 0, 0.4)' : 'rgba(0, 0, 0, 0.15)',
            },
          },
          data: chartData,
        },
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transform: is3D ? 'rotateX(10deg) rotateY(-5deg)' : 'rotateX(0deg) rotateY(0deg)',
